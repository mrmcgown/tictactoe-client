...
var onGameMove = function onGameMove(event) {
  ...
  if (event.target.innerText === '') {
    ...
    if (boolstuff) {
      ...
      api.gameMove(gameMovePatch).then(ui.gameMoveSuccess).catch(ui.gameMoveFailure);
    } else {
...
var onViewFinishedGames = function onViewFinishedGames(event) {
  event.preventDefault();

  api.viewFinishedGames().then(ui.viewFinishedGamesSuccess).catch(ui.viewFinishedGamesFailure);
};

var onViewCurrentGames = function onViewCurrentGames(event) {
  event.preventDefault();

  api.viewCurrentGames().then(ui.viewCurrentGamesSuccess).catch(ui.viewCurrentGamesFailure);
};
...
var gameMove = function gameMove(data) {
  return $.ajax({
...
var viewFinishedGames = function viewFinishedGames(data) {
  return $.ajax({
...
var viewCurrentGames = function viewCurrentGames(data) {
  return $.ajax({
...
var showOldGame = function showOldGame(data) {
  return $.ajax({
...
module.exports = {
  newGame: newGame,
  gameMove: gameMove,
  viewFinishedGames: viewFinishedGames,
  viewCurrentGames: viewCurrentGames,
...
var gameMoveSuccess = function gameMoveSuccess(data) {
  $('#message').text('game move successful!');
  $('#message').css('background-color', 'green');
};

var gameMoveFailure = function gameMoveFailure(error) {
  $('#message').text('Error on game move attempt');
  $('#message').css('background-color', 'red');
  console.log('gameMoveFailure ran. Error is :', error);
};

var viewFinishedGamesSuccess = function viewFinishedGamesSuccess(data) {
...
var viewFinishedGamesFailure = function viewFinishedGamesFailure(error) {
  $('#message').text('Error on view finished games attempt');
  $('#message').css('background-color', 'red');
  console.log('viewFinishedGamesFailure ran. Error is :', error);
};

var viewCurrentGamesSuccess = function viewCurrentGamesSuccess(data) {
...
var viewCurrentGamesFailure = function viewCurrentGamesFailure(error) {
...
module.exports = {
  ...
  viewFinishedGamesSuccess: viewFinishedGamesSuccess,
  viewFinishedGamesFailure: viewFinishedGamesFailure,
  viewCurrentGamesSuccess: viewCurrentGamesSuccess,
  viewCurrentGamesFailure: viewCurrentGamesFailure
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
